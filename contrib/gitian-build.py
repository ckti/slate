...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/gitianuser/ion-gitian.sigs-old', 'gitian.sigs'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/slatecurrrency/slate', help='Specify the URL of the repository. Default is %(default)s')
