...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/slatecurrency/gitian.sigs.git', 'gitian.sigs'])
    if not os.path.isdir('slate-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/slatecurrency/slate-detached-sigs.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/slate/slate', help='Specify the URL of the repository. Default is %(default)s')
